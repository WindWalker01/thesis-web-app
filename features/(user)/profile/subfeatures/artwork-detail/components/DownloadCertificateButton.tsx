...
export function DownloadCertificateButton({ artwork }: Props) {
  ...
  return (
    <button
      ...
      className="border-primary/20 bg-primary/10 text-primary hover:bg-primary/15 inline-flex w-full items-center justify-center gap-2 rounded-xl border px-4 py-2 text-base font-semibold transition-colors disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
    >
