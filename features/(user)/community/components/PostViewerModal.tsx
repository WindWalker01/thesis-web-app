          ...
          <div className="flex max-h-[92vh] min-h-0 flex-col">
            <div className="border-border/70 bg-background/95 sticky top-0 z-20 flex items-center justify-between gap-3 border-b px-4 py-3 backdrop-blur sm:px-5">
              ...
              <button
                ...
                className="text-muted-foreground hover:bg-muted hover:text-foreground inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition"
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
              <article className="bg-card/90 overflow-hidden">
                        ...
                        <>
                          <DropdownMenuItem asChild className="cursor-pointer">
                            <Link
                              href={
                                editHref ??
                                `/community/edit-post/${post.postId}`
                              }
                ...
                <div className="px-4 pb-3 sm:px-5">
                  ...
                  <h2 className="text-foreground text-lg leading-snug font-black sm:text-xl">
                    {post.title}
                  </h2>
                ...
                <div className="text-muted-foreground flex items-center justify-between gap-3 px-4 py-3 text-sm sm:px-5">
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      {post.upvoteCount} upvotes • {post.downvoteCount}{" "}
                      downvotes
                    </span>
                  </div>
                </div>
