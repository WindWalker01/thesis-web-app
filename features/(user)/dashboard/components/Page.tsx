                        ...
                        {statCards.map((card, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="text-sm font-bold text-foreground mt-0.5">{card.label}</p>
                                    ...
                                    return (
                                        <div key={item.label} className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className={`font-black truncate ${"small" in item && item.small ? "text-sm" : "text-base"} text-foreground`}>
                                                    {item.value}
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        ...
                        >
                            <div className="flex items-center justify-between px-5 py-4 border-b border-border">
                                ...
                                <Link href="/profile" className="text-sm text-primary font-semibold hover:underline flex items-center gap-1 shrink-0">
                            ...
                            <div className="divide-y divide-border">
                                {dashboard.topPosts.map((post, i) => (
                                    ...
                                    >
                                        <span className="text-sm font-black text-muted-foreground w-4 shrink-0 text-center">
                                            #{i + 1}
                                        </span>
