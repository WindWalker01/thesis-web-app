...
const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { id: "notifications",      label: "Notifications",      icon: Bell,       group: "Account",      href: "/settings-button/notifications" },
  ...
  { id: "upload-artwork",     label: "Upload Artwork",     icon: Upload,     group: "Quick Links",  href: "/upload-form" },
];
