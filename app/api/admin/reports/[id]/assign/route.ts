// ============================================
// POST /api/admin/reports/[id]/assign - Assign admin to report
// ============================================
...
export async function POST(
  ...
  try {
    ...
    const validation = assignAdminSchema.safeParse(body);
    ...
    const result = await service.assignAdminToReport(supabase, {
      reportId: id,
      adminId: validation.data.admin_id,
